# Project Moonlight: Auto-Verification Script (Fixed V7)
# "The King does not work. The King commands."
...
Write-Host "[Ark] Building 'The Beast'..."
...
if ($LASTEXITCODE -eq 0) {
    Write-Host "[Ark] VERIFICATION SUCCESSFUL. The Beast is Alive."
}
else {
