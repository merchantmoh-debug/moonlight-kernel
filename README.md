...
It is an **AI-Native Software Factory** where the code itself is synthesized by AI, compiled to WebAssembly, and executed in a Zero-Copy Shared Memory Arena.
...
How do you write 46,000 lines of rigorous math code in an afternoon?
**You don't. The Machine does.**

Project Moonlight includes the **Ark Synthesizer** (`scripts/synthesize_moonbit_kernel.py`).
*   **Input:** Mathematical definitions (Matrix<T>, Vec3, Mat4x4).
